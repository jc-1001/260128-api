...
if( $id > 0 ) {
  ...
  // 抓取訂單主檔
    ...
    $sql_items = "SELECT oi.product_id, oi.product_name AS name, oi.price, oi.quantity AS qty, oi.product_spec AS spec, p.image FROM order_items oi LEFT JOIN products p ON oi.product_id  = p.product_id WHERE oi.order_id = ?";
